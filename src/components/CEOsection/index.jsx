    ...
    <section className="bg-black text-white py-12 px-6 md:px-16">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-stretch gap-12">
        ...
        <div className="bg-white text-black rounded-xl shadow-lg p-6 w-full md:w-1/3 flex flex-col items-center justify-center h-full">
          ...
          <p className="text-sm text-gray-700 mb-2">
            Phone: 92-05811-960011-137
          </p>
          <p className="text-sm text-gray-700">Email: manzoor.ali@kiu.edu.pk</p>
        </div>
        ...
        <div className="flex-1 bg-transparent flex flex-col justify-center h-full">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            Silicon Global Tech (SGT) was officially incorporated on 10th
            November 2023, marking the beginning of a journey driven by
            innovation, technology, and excellence. At the heart of this vision
            stands our founder,{" "}
            ...
            foundation of SGT as a hub of creativity, problem-solving, and
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            ...
            pushing boundaries in software development, UI/UX design, accounting
            tools, and digital solutions.
          </p>
